...
import { Mail, Phone, MapPin, Send, MessageSquare, CheckCircle2, ShieldCheck, Zap, Globe } from 'lucide-react'
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="space-y-12">
              <div className="space-y-6">
                ...
                >
                  Get in <br /><span className="text-gradient pr-4">Touch</span>
                </motion.h1>
                ...
                >
                  Establish a direct uplink with our engineering team. We're here to optimize your preparation sequence.
                </motion.p>
              </div>
                  ...
                  {isSubmitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                      <div className="space-y-2">
                        <h3 className="text-3xl font-display font-black tracking-tighter uppercase italic">Transmit Intel</h3>
                        <p className="text-muted-foreground font-medium">Initialize the communication protocol below.</p>
                      </div>
                      ...
                      <Button 
                        ...
                        variant="default"
                        className="h-24 text-2xl font-black rounded-3xl uppercase tracking-[0.2em] shadow-2xl shadow-primary/20"
                      >
                        SEND TRANSMISSION <Send className="ml-3 w-6 h-6" />
                      </Button>
                    </form>
                  )}
                </AnimatePresence>
