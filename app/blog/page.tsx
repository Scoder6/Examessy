...
import { Calendar, Clock, ArrowRight, ArrowLeft, Share2, MessageSquare, Bookmark } from 'lucide-react'
            ...
            >
              <div className="flex flex-col items-center text-center space-y-8">
                ...
                <h1 className="text-7xl md:text-9xl font-display font-black tracking-tighter uppercase italic leading-[0.85] pb-4">
                  Tactical <br /><span className="text-gradient pr-4">Insights</span>
                </h1>
              ...
              <div className="space-y-12">
                ...
                <div className="pt-20 border-t border-white/5">
                   <Card variant="glass" className="p-12 text-center space-y-8">
                      <h3 className="text-4xl font-display font-black tracking-tighter uppercase italic">Ready to Apply This Intel?</h3>
                      <p className="text-xl text-muted-foreground max-w-xl mx-auto">Join the network today and initialize your personalized preparation sequence.</p>
                      <Button size="xl" variant="default" className="h-20 px-12 rounded-2xl uppercase font-black tracking-widest shadow-2xl shadow-primary/20" onClick={() => router.push('/auth/sign-up')}>
                        START MISSION - ₹99
                      </Button>
                   </Card>
                </div>
