...
import { FeaturesBackground } from '@/components/3d/page-scenes'
import { MouseSpotlight } from '@/components/mouse-spotlight'
import { ScrollProgress } from '@/components/scroll-progress'
import { DramaticZap, DramaticChart, DramaticUsers, DramaticBrain, DramaticShield, DramaticLock } from '@/components/icons/dramatic-icons'
...
export default function FeaturesPage() {
  ...
  return (
    <main className="min-h-screen bg-background relative overflow-hidden selection:bg-primary/30">
      ...
      <section className="pt-48 pb-24 relative">
        <Container size="2xl">
          <div className="flex flex-col items-center text-center space-y-8 mb-24">
            ...
            <WordReveal
              text="Discover the high-end technology engineered to give you the ultimate edge in your preparation."
              className="text-xl md:text-2xl text-muted-foreground max-w-2xl font-clean font-medium opacity-80"
            />
          </div>

          <ScrollingText
            texts={['LIGHTNING PERFORMANCE', 'ADVANCED ANALYTICS', 'PEER COMPARISON', 'ADAPTIVE LEARNING', 'VERIFIED MATERIALS', 'SECURE ENVIRONMENT']}
            speed={40}
          ...
          <StaggerGrid className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, i) => (
              <DramaticReveal key={i} direction="up" delay={i * 0.08}>
      ...
      <ScrollingText
        texts={['MISSION CONTROL', 'SUB-SECOND LATENCY', 'MILITARY-GRADE ENCRYPTION', 'AI-DRIVEN ANALYTICS', 'CLOUD-NATIVE', '100% UPTIME']}
        speed={45}
        className="opacity-40 my-8"
        reverse
      />
            ...
            <Card variant="glass" className="p-12 md:p-24 overflow-hidden relative">
              ...
              <div className="grid lg:grid-cols-2 gap-16 items-center">
                <div className="space-y-8">
                  ...
                  <WordReveal
                    text="Our dashboard isn't just a screen; it's your tactical advantage. Real-time data processing, visual heatmaps, and adaptive scheduling all working in sync."
                  ...
                  <MagneticButton>
                    <SparkButton>
                      <LiquidButton className="h-14 px-10 rounded-2xl font-black uppercase tracking-widest bg-primary text-primary-foreground shadow-2xl shadow-primary/30">
                        Explore Platform
                      </LiquidButton>
                    </SparkButton>
                  </MagneticButton>
